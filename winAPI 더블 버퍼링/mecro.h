...
namespace mecro
{
	...
	inline Scale BitmapScale(LPCWSTR fileName)
	{
	...
	inline void DrawTextOut(HDC hdc, Transform transform, LPCWSTR text, COLORREF color = BLACK)
	{
	...
	inline void DrawBitmapTransparent(HDC hdc, Transform transform, LPCWSTR fileName, COLORREF color = PURPLE)
	{
		HDC MemDC = CreateCompatibleDC(hdc);
	...
	inline void DrawBitmapPartTransparent(HDC hdc, Transform transform, LPCWSTR fileName, int widthCell, int heightCell, int index, COLORREF color = PURPLE)
	{
		HDC MemDC = CreateCompatibleDC(hdc);
